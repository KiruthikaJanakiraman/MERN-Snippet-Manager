...
function Home(){
    ...
    return <div className="home">
        {!snippetEditorOpen && user &&
            <button className="btn-editor-toggle" onClick={() => setSnippetEditorOpen(true)}>Add snippet</button>}
        {snippetEditorOpen && (
            <SnippetEditor 
        ...
        {snippets.length>0 ? renderSnippets() : user && <p className="no-snippets-msg">No snippets have been added</p>}
        {user === null && (
